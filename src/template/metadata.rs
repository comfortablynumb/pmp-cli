...
/// IaC configuration in template
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IacConfig {
    /// Provider/executor name (e.g., "opentofu", "terraform")
    pub provider: String,
}
...
pub struct ProjectSpec {
    ...
    /// IaC configuration (executor/provider)
    pub iac: IacProjectConfig,
